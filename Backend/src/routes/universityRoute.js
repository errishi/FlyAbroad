...
import { allUniversity, deleteListedUniversityById, editListedUniversityById, newUniversityListing, universityViewDetails } from '../controllers/universityController.js';
...
universityRouter.delete("/:id", deleteListedUniversityById);        //auth middleware is not added and ✅ tested
