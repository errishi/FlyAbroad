...
const Benefit = () => {
  return (
    <div className='flex justify-around lg:flex-row md:flex-row flex-col lg:px-15 md:px-10 px-7 py-5 mt-20'>
      <div className='lg:my-auto'>
        <span className='bg-gray-200 px-3 py-1 rounded-md text-[#09585e]'>Benefits</span>
        <h1 className='text-[#09585e] lg:text-5xl md:text-4xl text-2xl font-bold mt-7'>Get Student ID Card</h1>
      ...
      <div className='lg:mt-0 mt-10'>
        <img src="/src/assets/student-idcard.svg" className='lg:w-auto md:w-100' alt="ID Card" />
      </div>
    </div>
  )
}
