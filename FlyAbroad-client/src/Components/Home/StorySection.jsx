...
const StorySection = () => {
  return (
    <div className='lg:px-15 md:px-10 px-7 py-5 lg:h-210 md:h-180 h-400 lg:mt-5 mt-10 text-center bg-[url(/design.svg)] bg-no-repeat bg-cover bg-center lg:mask-y-from-195 md:mask-y-from-165 mask-y-from-380 lg:mask-x-from-320'>
        ...
        <div className='grid lg:grid-cols-3 md:grid-cols-2 grid-cols h-115 overflow-y-hidden gap-5 mt-15 mx-20'>
