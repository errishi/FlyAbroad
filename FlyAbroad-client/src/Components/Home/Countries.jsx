...
const Countries = () => {
  return (
    <div className='lg:px-15 md:px-10 m-auto px-7 py-5 mt-20'>
        <h1 className='font-bold p-1 w-fit flex lg:items-center md:items-center text-center lg:text-4xl text-2xl drop-shadow-lg rounded bg-linear-to-l from-[#0B7077]/50 via-transparent to-transparent'>
