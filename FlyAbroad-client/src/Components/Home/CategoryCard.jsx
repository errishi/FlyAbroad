...
const CategoryCard = ({title, description, image}) => {
  return (
    <div className='rounded-xl bg-[#0B7077]/10 hover:shadow-lg transition-all hover:bg-radial-[at_25%_25%] from-[#F5F5F5] to-white to-75% w-70 h-80 smL:w-70 xs:w-60 lg:px-5 md:px-5 sm:px-5 px-5 xs:px-3 py-8 text-center border'>
