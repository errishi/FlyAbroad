    ...
    return (
        <div className='w-full h-full z-10 fixed bg-[#000000ba] grid'>
            <div className='flex lg:flex-row md:flex-row flex-col lg:m-auto md:mx-10 mx-5 shadow-xl rounded-2xl w-fit overflow-clip lg:top-[10%] lg:left-1/6 top-3 md:top-10 place-self-center'>
                ...
                <div className='bg-white lg:text-black md:text-black text-white lg:w-130 md:w-130 w-full p-10 relative'>
                    ...
                    <div onClick={() => setCurrentAuth(false)} className='border-2 lg:border-black md:border-black border-white w-fit h-8.5 flex items-center rounded-full p-1 cursor-pointer absolute lg:top-5 md:top-5 smL:-top-47 -top-37 lg:right-5 md:right-5 right-5 hover:opacity-65'>
                        <CloseIcon />
                    </div>
                </div>
            </div>
