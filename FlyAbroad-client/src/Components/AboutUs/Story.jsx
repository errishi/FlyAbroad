            ...
            <div className='flex lg:items-center lg:flex-row flex-col-reverse justify-around mt-8'>
                ...
                <div className='lg:w-160'>
                    ...
                    <p className='lg:text-xl md:text-xl text-[16px] mt-5'>
                        <p className='my-3'><b>The FlyAbroad Story :</b></p>
                        <b>FlyAbroad</b> has long been a trusted resource in international education—the go-to search engine where the journey began. But we realized that searching wasn’t enough. Students needed a simpler, more affordable way to actually go.
                        That’s why in 2025, we didn't just update our website; we reinvented our purpose. FlyAbroad has evolved from a directory into a full-service provider. We took years of data, deep global partnerships, and a legacy of quality, and re-engineered them into a bold, student-first platform.
                        ...
                        <b>FlyAbroad</b> is more than a platform - it’s a movement to make the world accessible to every student who dreams of seeing it.</p>
                </div>
            </div>
        </div>
    )
